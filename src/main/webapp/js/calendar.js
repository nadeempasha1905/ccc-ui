...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(presentDate.getFullYear() == to.start.getFullYear() && presentDate.getMonth() + 1 == to.start.getMonth()+1){
	...
	Calendar.prototype._init_position = function() {
		...
		var d = new Date();
		if(this.options.view == "month" && year-1 < (d.getFullYear()-1) &&  month == d.getMonth()){
			$('#prev')[0].disabled = true;
			$('#next')[0].disabled = false;
		}else if(this.options.view == "month" && month == d.getMonth()){
			$('#prev')[0].disabled = false;
			$('#next')[0].disabled = true;
		}else if(this.options.view == "year" && year == d.getFullYear()){
			$('#next')[0].disabled = true;
			$('#prev')[0].disabled = true;
		}else{
			$('#next')[0].disabled = false;
	...
	Calendar.prototype._update_modal = function() {
		...
		$('a[data-event-id]', this.context).on('click', function(event) {
			...
			if(event.title == "Pform"){
				modal = $("#pformmodal");				
			}else if(event.title == "Lform"){
				modal = $("#lformmodal");
			}else if(event.title == "Sform"){
				modal = $("#sformmodal");
			}
			if(self.options.modal_type == "iframe") {
				ifrm.attr('src', url);
	...
	Calendar.prototype._update_month_year = function() {
		...
		var downbox = $(document.createElement('div')).html('<i></i>');
